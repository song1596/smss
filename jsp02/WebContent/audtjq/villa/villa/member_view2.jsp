...
$(function(){
	...
	$("#btnUpdate").click(function(){
		//폼 데이터를 제출할 주소
		document.form1.action="/jsp02/aaa/update.do";
		//폼 데이터를 서버에 제출
		document.form1.submit();
	});
	$("#btnDelete").click(function(){
		if(confirm("삭제하시겠습니까?")){
			document.form1.action="/jsp02/aaa/delete.do";
			document.form1.submit();
		}
	});
});
...
<body>
<%
	aaa.AaaDTO dto=(aaa.AaaDTO)request.getAttribute("dto");
%>
