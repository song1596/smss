...
public class AaaDTO {
	...
	public String toString() {
		return "aaaDTO [userid=" + userid + ", passwd=" + passwd + ", name=" + name + ", email=" + email + ", hp="
	...
	public AaaDTO(String userid, String passwd, String name, String email, String hp, String zipcode,
